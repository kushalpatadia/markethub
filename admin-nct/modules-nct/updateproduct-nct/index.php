...
if(isset($_POST['updateproduct'])){
    ...
    {
        echo $result= "UPDATE `tbl_products` SET `title`='$title',`category`='$category',`subcategory`='$subcategory',`brand`='$brand',`price`='$price',`qty_available`='$qty_available',`size`='$size',`color`='$color',`shortDescription`='$short_description',`specification`='$specification',`additionalinfo`='$additional_info',`isActive`='y' WHERE id='$productdetails'";    
    }
    // exit();
    unset($_SESSION['pic']);
...
$obj = new UpdateProducts($module, 0, issetor($token));
