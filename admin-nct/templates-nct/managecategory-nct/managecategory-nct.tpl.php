...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    %DYNAMIC-MENU%
        ...
        <li class="active"><a href="{SITE_ADM_MOD}managecategory-nct"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg>Manage Category</a></li>
      ...
      <div style="height:50px;"></div>
        <div class="panel panel-default">
            <div class="panel-heading">
                    <div align='center'>
                        Manage Category
                        <button class="btn btn-success rightbtn" name="addCategory" data-toggle="modal" data-target="#addCategory">Add Category</button>
                    </div>
            </div>
            <div class="panel-body">
                <table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                  <thead>
                      <tr>
                          <th data-field="id1" data-sortable="true">Category Name</th>
        ...
        <div class="modal-body">
            <div class="login-page" style="width:80%;">
                <form class="wow fadeInUp animated" data-wow-delay=".7s" action="" method="POST">
                    <h4><label for="title">Category Name:</label></h4><br>
                    <input type="text" placeholder="Category Name" name="category" required="">
                    <h4><label for="title">Link:</label></h4><br>
