    ...
    <div class="login-page">
        ...
        <div class="widget-shadow">
            ...
            <div class="login-body">
                ...
                <form class="wow fadeInUp animated" data-wow-delay=".7s" action="" id="form" method="POST" enctype="multipart/form-data">
                    ...
                    <h4><label for="color">Select Product's Color:</label></h4>
