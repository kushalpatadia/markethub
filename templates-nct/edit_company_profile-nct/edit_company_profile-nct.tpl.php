...
<section class="inner-section">
    <div class="container">
      ...
      <div class="profile-content">
        <div class="row">
          <div class="col-md-12">
          <div class="cover-company-profile-edit">
              <img class="img-responsive" src="%COVER_IMAGE%">
              <div class="bottom-icon-block">
                  <div class="rd-icon"><a href="javascript:void(0);" class="edit-btn company-edit-btn" data-toggle="modal" data-target="#avatar-modal_cover" ><i class="fa fa-pencil" aria-hidden="true"></i></a></div>
              </div>
            </div>
                  ...
                  <div class="common-form pad-btm-none">
                    <form action="" method="POST" name="frm_profile" id="frm_profile">
                      <div class="row">
                        ...
                        <div class="col-sm-10">
                          <div class="row">
                                <div class="col-sm-6 pad-top20">
                                  <div class="form-group">
                                    <label>Company name<span class="red-text">*</span></label>
                                    <input type="text" placeholder="Enter company name" id="company_name" name="company_name" value="%COMPANY_NAME%" class="form-control">
                                  </div>
                                </div>
                                <div class="col-sm-6 pad-top20">
                                  <div class="form-group">
                                    ...
                                    <div class="form-control">
                                      <div class="root"> <span class="value">Industry type</span>
                                        ...
                                        <span for="industry" generated="true" class="help-block validation"></span>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-control">
                                      <div class="root"> <span class="value">Select country</span>
                                        ...
                                        <span for="country" generated="true" class="help-block validation"></span>
                                      </div>
                                    </div>
                                  </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-control">
                                      <div class="root"> <span class="value">Select State</span>
                                        ...
                                        <span for="state" generated="true" class="help-block validation"></span>
                                      </div>
                                    </div>
                                  </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-control">
                                      <div class="root"> <span class="value">Select City</span>
                                        ...
                                        <span for="city" generated="true" class="help-block validation"></span>
                                      </div>
                                    </div>
                                  </div>
                                 </div>
                                ...
                                <div class="col-sm-12">  
                                    <div class="form-group">
                                        ...
                                        <a href="{SITE_URL}Company-profile" class="common-btn">Cancel</a>
                                    </div>
                                </div>
                          </div>
                        </div>
...
function showdata_cover(){
    ...
    var formnew = document.getElementById("avtar_form_cover"); 
    var formData = new FormData(formnew);
...
$(document).ready(function(){  
  $("#frm_profile").validate({   
            ...
            messages : {
                ...
                industry: {required:"Please Select Industry type."},
